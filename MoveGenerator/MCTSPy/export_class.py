...
def default_mcts_map_hand_eval_func(fixed_hand, map_hand, map_remaining, tile_remaining, additional_tile = None):
	...
	if failing_criteria[ScoringRules.HKRules.__score_lower_limit](chow_suits, pong_suits, is_honor, is_rgw):
		return 0
	...
	if ScoringRules.HKRules.__score_lower_limit == 1:
...
class RuleBasedAINaiveMCTSPy(MoveGenerator):
