...
class Calculate_score_test(unittest.TestCase):
	def test_all_pongs(self):
		...
		score = ScoringRules.HKRules.score_all_pongs([], grouped_hands[0])
	...
	def test_one_nines(self):
		...
		score = ScoringRules.HKRules.score_ones_nines([], grouped_hands[0])
	...
	def test_mixed_suit(self):
		...
		score = ScoringRules.HKRules.score_one_suit([], grouped_hands[0])
		self.assertEqual(score, 3)
	...
	def test_small_honors(self):
		...
		grouped_hands = ScoringRules.HKRules.validate_hand([], hand, white)
		score = ScoringRules.HKRules.score_honor_tiles([], grouped_hands[0])
	...
	def test_small_four_winds(self):
		...
		score = ScoringRules.HKRules.score_four_winds([], grouped_hands[0])
